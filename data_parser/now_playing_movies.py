...
def crawl_now_playing_movies_id():
    ...
    url_stem = 'https://api.themoviedb.org/3/movie/now_playing?'
    url_var = '&'.join(
...
movies = crawl_now_playing_movies_id()

# Save now_playing movies
data_file = os.path.join(data_folder, 'now_playing_movies.json')
with open(data_file, 'w') as stream:
    json.dump(movies, stream)

# Load now_playing movies and transform to dictionary
data_file = os.path.join(data_folder, 'now_playing_movies.json')
...
# Save now_playing movies details
data_file = os.path.join(data_folder, 'now_playing_movies_details.json')
with open(data_file, 'w') as stream:
    json.dump(movies_detail, stream)
    
# Load now_playing movies details and transform to dictionary
data_file = os.path.join(data_folder, 'now_playing_movies_details.json')
with open(data_file, 'r') as stream:
...
# Save now_playing movies synopsis
data_file = os.path.join(data_folder, 'now_playing_movies_synopsis.json')
with open(data_file, 'w') as stream:
    json.dump(synopsis, stream)
    
    
    
# Load now_playing movies synopsis
data_file = os.path.join(data_folder, 'now_playing_movies_synopsis.json')
with open(data_file, 'r') as stream:
...
# Save now_playing movies synopsis parsed
data_file = os.path.join(data_folder, 'now_playing_movies_synopsis_parsed.json')
with open(data_file, 'w') as stream:
